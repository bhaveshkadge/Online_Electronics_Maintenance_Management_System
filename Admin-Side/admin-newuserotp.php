<!-- Code for Admin to reset password -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="admin-newuserotp.php" method="POST" autocomplete="off">   <!-- Form Starts -->
                    ...
                    <div class="form-group">
                        <input class="form-control" type="number" name="admin-newuserotp" placeholder="Enter verification code" required>
                    </div>
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="admin-newcheck" value="Submit">
                    </div>
                </form>     <!-- Form Ends -->
            </div>
        </div>
