<!-- Code for Admin to forgot their password -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="admin-newforgotpassword.php" method="POST" autocomplete="">   <!-- Form Starts -->
                    ...
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="admin-newcheckemail" value="Continue">
                    </div>
                </form>     <!-- Form Ends -->
            </div>
        </div>
